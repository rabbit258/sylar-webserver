...
static sylar::ConfigVar<uint64_t>::ptr g_http_response_buff_size = 
...
struct _RequestSizeIniter {
    _RequestSizeIniter() {
        ...
        s_http_response_buffer_size = g_http_response_buff_size->getValue();
        ...
        g_http_response_buff_size->addListener(
            [](const uint64_t& ov,const uint64_t& nv){
